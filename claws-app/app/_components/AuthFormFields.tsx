...
// Inline SVG eye icons — replaces the Material Symbols ligature span so
// the toggle doesn't depend on a webfont loading first. Same paths as the
// official Material Icons set.
function EyeIcon() {
  return (
    ...
    <div>
      ...
      <div className="relative">
        ...
        <button
          ...
          tabIndex={-1}
          className="absolute inset-y-0 right-0 px-3 flex items-center text-[#94afd5] hover:text-[#006092] transition-colors"
        >
